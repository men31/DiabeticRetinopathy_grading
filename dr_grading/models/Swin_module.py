...
class Swin_V2_S(nn.Module):
    ...
    def __create_architecture(self):
        ...
        head = ClassifierHead(768, self.num_classes, self.hidden_layers, activation=self.activation)
...
class Swin_V2_B(nn.Module):
    ...
    def __create_architecture(self):
        ...
        head = ClassifierHead(1024, self.num_classes, self.hidden_layers, activation=self.activation)
        model_lst.append(head)
